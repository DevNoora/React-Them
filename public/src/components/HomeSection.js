        ...
        <div className="home__wrapper">
          <div className="home__info">
            ...
            <ParagraphText className="home__desc">
              Because every learn tells a story, let us help you tell yours course.
            </ParagraphText>
            <PrimaryButton
              buttonType={Link}
              smooth
          ...
          <div class="col-lg-5 col-md-5 text-center">
            <div class="home-image">
              ...
              <img src="https://static.wixstatic.com/media/57245c_2311ec8f340742c2a042a96f7cdf1c80~mv2.png/v1/fill/w_380,h_380,al_c,q_85,usm_0.66_1.00_0.01/app-01.webp" />
            </div>
          </div>
        </div>
      </div>
